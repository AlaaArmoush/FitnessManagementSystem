...
public class InstructorProgramManagementSteps {
	...
	public void the_instructor_wants_to_create_new_program_with_title_as_the_duration_time_as_the_difficulty_level_as_the_goals_as(
			String title, String durationTime, String difficultyLevel, String goals) {
		String instructorId = "instructor11";
		String programId = ProgramDataBase.generateProgramId();

		boolean programExists = ProgramDataBase.addNewProgram(title, durationTime, difficultyLevel, goals, instructorId,
				programId, attachmentsTest, "100");
	...
	public void the_instructor_wants_to_update_the_program_details_with_title_to_the_duration_to_the_difficulty_level_to_the_goals_to_to_program_with_id(
			String title, String durationTime, String difficultyLevel, String goals, String id) {
		boolean updated = ProgramDataBase.updateProgramDetails(title, durationTime, difficultyLevel, goals,
				id.toString());
	...
	public void the_instructor_wants_to_set_a_schedule_for_the_program_with_id_chooses_session_type_as_schedual_as(
			String id, String type, String schedule) {
	...
	public void the_instructor_wants_to_set_a_schedule_and_chooses_session_type_as_schedual_as_for_the_program_with_id(
			String type, String schedule, String id) {
